...
PUBLIC = [  # expect 200
    ...
    ("GET", "/api/score-history/movers?days=7&direction=up&limit=5", None),
    ("GET", "/api/score-history/VOLV-B.ST?days=7", None),
    ("GET", "/api/signal-transitions/VOLV-B.ST?days=7", None),
